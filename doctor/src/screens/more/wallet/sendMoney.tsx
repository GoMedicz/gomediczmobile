...
const fetchBalance = async()=>{
  ...
  let url = ServerUrl+'/api/doctor/balance/'+wallet
   ...
   if (buttonIndex === 1) {
      //Process the information here
          ...
          let fd = {
            ...
            transaction_ref:Math.random().toString(36).substring(2, 9),
            transaction_mode:'withdrawal',
            date_request:today
          }
let url = ServerUrl+'/api/doctor/withdrawal';
