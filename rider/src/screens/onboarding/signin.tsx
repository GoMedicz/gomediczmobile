...
setLoading(true)
  ...
  let url = ServerUrl+'/api/rider/login';
...
let url = ServerUrl+'/api/rider/verification';
...
<View style={{backgroundColor:colors.primary, height:(height/2)+60}}>
  ...
  <Text style={[styles.buttonText, {color:colors.navyBlue, fontSize:12, marginVertical:5, letterSpacing:1}]}>DELIVERY</Text>
    </View>
