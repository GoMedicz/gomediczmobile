...
type Props = NativeStackScreenProps<RootStackParamList, 'LabMapView'>;
 const LabMapView =({ route, navigation }:Props)=> {
...
<Text style={[styles.infoText, {marginTop:10, color:colors.navyBlue}]}>120+ Tests available</Text>
  ...
  return (<View style={[ {flex:1, backgroundColor:colors.lightSkye}]}>
    ...
    <Text style={styles.label}>Map View Labs</Text>
